...
/*   Updated: 2024/09/27 17:43:55 by apardo-m         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	Bureaucrat::executeForm( AForm const & form ) const
{
	try
	{
		std::cout << this->getName() << " try to execute form: " << form.getName() << ", exec grade : " << form.getGradeToExec() << std::endl;
		form.execute(*this);
		std::cout << "\tForm '" << form.getName() << "' has been executed !!!" << std::endl;
	}

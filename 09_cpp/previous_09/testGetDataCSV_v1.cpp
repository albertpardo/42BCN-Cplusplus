...
static bool isValidDate(const std::string& dateString, struct tm &ans)
{
    char char1 = ' ';
    char char2 = ' ';
...
static void	checkDate(std::string const & date, struct tm &ans)
{
	if (!isValidDate(date, ans))
